...
namespace HoloToolkit.Unity.InputModule
{
    ...
    public class TapToPlace : MonoBehaviour, IInputClickHandler
    {
        ...
        protected virtual void Update()
        {
            ...
            Bounds objBounds = GetBoundsForAllChildren(gameObject);
            ...
            placementPosition = new Vector3(placementPosition.x, placementPosition.y, placementPosition.z);
        ...
        private Bounds GetBoundsForAllChildren(GameObject obj)
        {
            Bounds result = new Bounds(Vector3.zero, Vector3.zero);

            foreach (var curRenderer in obj.GetComponentsInChildren<Renderer>())
            {

...
namespace HoloToolkit.Unity.InputModule
{
    ...
    /// </summary>
    public class HandDragging : MonoBehaviour, IFocusable, IInputHandler, ISourceStateHandler
    {
        /// <summary>
        ...
        public enum AxisConstraintEnum
        {
            X,
            Y,
            Z,
        ...
        public AxisConstraintEnum axisConstraint = AxisConstraintEnum.None;
        ...
        private Vector3 handPositionLocal;
        ...
        private Vector3 hostTransformStartPos;
        private Vector3 hostTransformTargetPos;

        public Vector3 startPos;
        public bool startPosHasSet = false;
        ...
        private void Start()
        {
            ...
            hostTransformStartPos = HostTransform.position;
        ...
        public void StartDragging()
        {
            ...
            handPositionLocal = mainCamera.transform.InverseTransformPoint(handPosition);
        ...
        private void UpdateDraggingPosition()
        {
            if (!startPosHasSet)
            {
                ...
                startPos = ApplicationState.Instance.SelectedGameObject.transform.InverseTransformPoint(startPos);
                startPosHasSet = true;
            }
            ...
            hostTransformTargetPos = Vector3.Lerp(HostTransform.position, draggingPosition + mainCamera.transform.TransformDirection(objRefGrabPoint), PositionLerpSpeed);

            // Apply Final Position
            if (axisConstraint == AxisConstraintEnum.X)
            {
                HostTransform.position = new Vector3(hostTransformTargetPos.x, hostTransformStartPos.y, hostTransformStartPos.z);
            }
            else if (axisConstraint == AxisConstraintEnum.Y)
            {
                HostTransform.position = new Vector3(hostTransformStartPos.x, hostTransformTargetPos.y, hostTransformStartPos.z);
            }
            else if (axisConstraint == AxisConstraintEnum.Z)
            {
                HostTransform.position = new Vector3(hostTransformStartPos.x, hostTransformStartPos.y, hostTransformTargetPos.z);
            }
            else
            {
                HostTransform.position = hostTransformTargetPos;
            }
